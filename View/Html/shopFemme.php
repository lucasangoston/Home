...
<body>
    ...
    <img src = "View/img/femme_accueil.jpg" width="100%" height="100%"/>
                ...
                for($nb=$i;$nb<3+$i;$nb+=1)
                {
                    if(!empty($data[$nb])) {
                        ...
                        <li>
                            <p>
                                <div>
                                    <a href="index.php?page=detailArticle&amp;id=<?= $data[$nb]['id'] ?>">
                                        <img src="<?= $data[$nb]['url'] ?>" width="400" height="auto" class="entoureimage"/></a>
                                </div>
